...
public class ImportFromCSVDialog extends AbstractSimplePanelDialog {
  ...
  protected void fillDialogPanel(DialogPanel panel) {
    panel.addRow(coreString("import.csv.dialog.file"), chooseCsvFile);

    panel.addRow(coreString("import.csv.dialog.enc"), encoding);

    JPanel component0 = new JPanel(new FlowLayout(FlowLayout.LEFT, 0, 0));
    component0.add(rowField);
    panel.addRow(coreString("import.csv.dialog.firstrow"), component0);

    JPanel component1 = new JPanel(new FlowLayout(FlowLayout.LEFT, 0, 0));
    component1.add(columnField);
    panel.addRow(coreString("import.csv.dialog.taskcol"), component1);

    JPanel component2 = new JPanel(new FlowLayout(FlowLayout.LEFT, 0, 0));
    component2.add(delimField);
    panel.addRow(coreString("import.csv.dialog.delim"), component2);
  }
