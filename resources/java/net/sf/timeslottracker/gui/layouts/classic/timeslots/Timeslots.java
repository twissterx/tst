 ...
 *
 * File version: $Revision: 1123 $, $Date: 2009-05-16 08:53:21 +0700 (Sat, 16
 * May 2009) $ Last change: $Author: ghermans $
 */
...
public class Timeslots extends JPanel implements TimeSlotsInterface,
  ...
  void createColumns() {
    ...
    for (int column = 0; column < tableModel.getColumnCount()
      ...
      logger.info("CurrentIndex=" + currentIndex + "; column=" + column
