 ...
 * 
 * @version File version: $Revision: 1128 $, $Date: 2009-05-16 09:00:38 +0700
 *          (Sat, 16 May 2009) $
...
public class Starter extends JFrame implements TimeSlotTracker {
  ...
  public void errorLog(String message) {
    // System.err.println(getString("starter.log.error.title")+" "+message);
    LOG.severe(message);
  }
  ...
  public void debugLog(String message) {
    /*
     * It's now done via logger from java.util.logging package. if
     * (System.getProperty("debug")!=null) {
     * System.out.println(getString("starter.log.debug.title")+" "+message); }
     */
    LOG.info(message);
  }
