 ...
 *
 * @version File version: $Revision: 1155 $, $Date: 2009-08-04 19:26:06 +0700
 *          (Tue, 04 Aug 2009) $
...
public class Configuration {
  ...
  /**
   * Returns <code>true</code> if <code>developer-version</code> property from
   * <code>version</code> is <code>"true"</code>.
   */
  public boolean isDeveloperVersion() {
    return Boolean.valueOf(version.getProperty("developer-version", "false"))
        .booleanValue();
  }
